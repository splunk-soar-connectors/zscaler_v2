...
class AddCategoryIpSummary(ActionOutput):
    message: str = OutputField(example_values=["Category ips updated"])
...
def add_category_ip(
    ...
    soar.set_summary(AddCategoryIpSummary(message="Category ips updated"))
