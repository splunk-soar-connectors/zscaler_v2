...
def test_unblock_ip_live_updates_activates_and_is_idempotent(
    connector_app: App,
    ...
    with get_client(asset) as client:
        ...
        prepared, _response, error = (
            client.zia.security_policy_settings.add_urls_to_blacklist([_TEST_IP])
        )
        assert error is None
    ...
    try:
        ...
        with get_client(asset) as client:
            ...
            assert _TEST_IP not in changed.blacklist_urls
    finally:
        with get_client(asset) as client:
