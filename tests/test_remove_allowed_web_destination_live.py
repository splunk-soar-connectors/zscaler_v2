...
_TEST_URL = "papp-38277-remove-allow.example"
_TEST_IP = "192.0.2.80"


def test_remove_allowed_web_destination_live_handles_mixed_inputs(
    connector_app: App,
    ...
    assert second.get_message() == "Allowlist contains none of these destinations"
